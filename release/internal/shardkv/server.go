...
func (kv *KVServer) FreezeShard(args *shardrpc.FreezeShardArgs, reply *shardrpc.FreezeShardReply) error {
...
func (kv *KVServer) InstallShard(args *shardrpc.InstallShardArgs, reply *shardrpc.InstallShardReply) error {
...
func (kv *KVServer) DeleteShard(args *shardrpc.DeleteShardArgs, reply *shardrpc.DeleteShardReply) error {
...
func StartServerShardGrp(servers []*transport.ClientEnd, gid shardcfg.Tgid, me int, persister *storage.FilePersister, maxraftstate int) *KVServer {
